...
namespace Nop.Plugin.Payments.NOWPayments.Components
{
    public class PaymentNOWPaymentsViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.NOWPayments/Views/PaymentInfo.cshtml", model);
        }
    }
}
